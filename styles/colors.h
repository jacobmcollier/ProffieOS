...
typedef Rgb<000, 000, 255> Blue;
typedef Rgb<000, 255, 225> IceBlue;
typedef Rgb<000, 255, 150> CoolBlue;
typedef Rgb<000, 255, 075> PerfectCyan;
typedef Rgb<000, 255, 050> Teal;
typedef Rgb<000, 255, 015> ViridianGreen;
typedef Rgb<000, 255, 000> Green;
typedef Rgb<050, 255, 000> Lime;
typedef Rgb<255, 210, 000> Yellow;
typedef Rgb<255, 175, 000> Amber;
typedef Rgb<255, 120, 000> BrightOrange;
typedef Rgb<255, 045, 000> OrangeRed;
typedef Rgb<255, 000, 000> Red;
typedef Rgb<075, 000, 255> Purple;
typedef Rgb<150, 000, 255> Violet;
typedef Rgb<150, 075, 255> MediumPink;

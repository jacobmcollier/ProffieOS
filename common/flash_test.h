#ifndef COMMON_FLASH_TEST_H
#define COMMON_FLASH_TEST_H

struct FlashTestHistogram {
  FlashTestHistogram() {
...
private:
  char filename_[256];
  FlashTestHistogram histogram;
  FlashTestHistogram open_histogram;
};
